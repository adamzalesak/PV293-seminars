...
namespace Library.DataAccess.Migrations
{
    ...
    [Migration("20251018204748_AddBookIsAvailableProperty")]
    partial class AddBookIsAvailableProperty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Domain.Aggregates.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Library.Domain.Aggregates.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Library.Domain.Aggregates.Loan.Loan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Library.Domain.Aggregates.Book", b =>
                {
                    b.HasOne("Library.Domain.Aggregates.Author", "Author")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Library.Domain.Aggregates.Loan.Loan", b =>
                {
                    b.OwnsMany("Library.Domain.Aggregates.Loan.Fine", "Fines", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("TEXT");
                            ...
                            b1.OwnsOne("Library.Domain.ValueObjects.Money", "Amount", b2 =>
                                {
                    ...
                    b.OwnsOne("Library.Domain.ValueObjects.LoanPeriod", "Period", b1 =>
                        {
                            b1.Property<Guid>("LoanId")
                                .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Library.Domain.Aggregates.ApplicationUser", null)
                        .WithMany()
